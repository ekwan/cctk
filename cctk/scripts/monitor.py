...
print("{0:5} {1:20} {2:20} {3:15} {4:15} {5:20}".format("#", "Energy (Hartree)", "Rel Energy (kcal)", "SCF Cycles", "RMS Force", "RMS Displacement"))

min_energy = np.min(energies)
for i, energy in enumerate(energies):
    rel_energy = (energy - min_energy) * 627.509 #### convert to kcal
    print("{0:5d} {1:20.5f} {2:20.5f} {3:15d} {4:15.5f} {5:20.5f}".format(i+1, energy, rel_energy, scf_iter[i], rms_forces[i], rms_displacements[i]))
