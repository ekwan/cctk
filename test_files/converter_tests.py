...
geometries, symbols, bonds, property_names, property_values, contains_conformers = read_mae("dodecane_csearch-out.mae", contains_conformers=True)
geometry_index = -1
for symbol,position in zip(symbols,geometries[geometry_index]):
    x,y,z = position
...
print(bonds.edges)
print("contains_conformers:", contains_conformers)
